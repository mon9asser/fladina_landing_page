...
class Fladina_Apis {
  ...
  // This line taking about " How many time you will reply to your client email "
  //-> Email
    private $email_to = "moun2030@gmail.com";
  //-> Reply Time
    private $reply_time = "24 Hours";


  // Responsed Message to Ajax
  ...
  public function Auto_replay_to_message_sent_success (){
    return $this->successMessage.' '.$this->reply_time;
  }
}
